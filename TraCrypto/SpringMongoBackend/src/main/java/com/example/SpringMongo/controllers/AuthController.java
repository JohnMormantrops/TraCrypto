...
import com.example.SpringMongo.payload.request.LoginRequest;
import com.example.SpringMongo.payload.request.SignupRequest;
import com.example.SpringMongo.payload.response.JwtResponse;
import com.example.SpringMongo.payload.response.MessageResponse;
import com.example.SpringMongo.repositories.RoleRepository;
import com.example.SpringMongo.security.jwt.JwtUtils;
import com.example.SpringMongo.security.services.UserDetailsImpl;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        System.out.println("Authenitication?");
